...
2. Install dependencies and run the project as described in the [README](README.md).
...
New here? Look for issues labeled [`good first issue`](../../issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22)
— they're small, scoped, and have enough context to start. Ask questions right
in the issue; I usually reply within a day.

## Reporting bugs and ideas

Open an issue using the provided templates. Clear reproduction steps (for bugs)
or a concrete use case (for ideas) help a lot.

By contributing, you agree that your contributions will be licensed under the
same license as this project, and that you will follow the
